...
of electron-positron collisions with the International Linear Collider
(ILC).  This program will begin with a
central focus on precision and  model-independent measurements of the Higgs-boson couplings.   This method of searching for 
new physics beyond the Standard Model is orthogonal to and complements 
direct new particle searches at the LHC.   The first stage of the ILC
at 250~GeV will also search for new physics in exotic Higgs decays
and in pair-production of weakly interacting particles.
Polarised electron
and positron beams add to the physics reach.
The ILC can
...
The central issue in particle physics today is the search for new
...
themselves as new particles, new forces, 
 ...
 self-consistent,
it leaves many central issues of particle physics unaddressed. 
...
nothing to say about the mass scale of quarks, leptons, and gauge 
...
interactions of the Higgs boson is thus of upmost importance.
...
tests of SM expectations.  An $\ee$ linear collider  offers
powerful tools for these tests, including the well-defined center of
mass energy, the small size of troublesome backgrounds, and the
available of high beam polarisation to provide a new suite of
observables.    A linear collider allows straightforward energy
...
on $1.3\,{\mathrm{GHz}}$ superconducting radio-frequency (SCRF)
...
Most important is the ability to begin with a high-precision study of the Higgs-boson couplings.  The ILC at 250~GeV also
...
\begin{figure}
\begin{center}
\includegraphics[width=0.80\hsize]{figures/ModelindepSummary.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.80\hsize]{figures/ModeldepSummary.pdf}
...
is a new experimental method in which all individual Higgs-boson decays
are manifest
...
$\ee\to Zh$ at 250~GeV in the centre-of-mass.
  ...
  boson.  By selecting such events, we gain a complete picture of Higgs-boson  decays to SM leptonic and hadronic modes, as well as to invisible or
  partially visible exotic modes. 

Further, since the cross section for Higgs production can be measured
independently of any property of the Higgs boson, the scale of Higgs
...
mass  differences among Higgsinos are smaller than a few GeV---which is
...
gradient electron accelerators reaching energies of tens of TeV.   The 
...
physics objectives outlined in this document  with high energy-efficiency.  In the design, we limit
the overall power consumption of the accelerator complex during operation to $129\,{\mathrm{MW}}$ at  $250\,{\mathrm{GeV}}$ and $300\,{\mathrm{MW}}$ at  $1\,{\mathrm{TeV}}$, which is comparable to the power consumption of CERN today.
...
operation 
at $2^\circ{\mathrm{K}}$. Some relevant parameters are given in \Tab{tab:ilc-params}.
...
facilities that are in operation (European XFEL at DESY,
Hamburg), under construction (LCLS-II at SLAC, Stanford),
...
for the ILC in Japan, looking for  suitable geological conditions
 for a tunnel up to $50\,{\mathrm{km}}$ in length (as required for a
 $1\,{\mathrm{TeV}}$  machine), and the possibility to establish a
...
since 2017, 97 of these cryomodules have been in operator at the
...
\begin{itemize}
 \item The detector must have excellent track momentum
   resolution, of about $2 \times 10^{-5} \mathrm{GeV}^{-1}$. 
...
prediction of the Higgs boson properties.  In order that 
...
long-lived particles with excellent specificity and high efficiency.
 As a typical number, the position of the reconstructed secondary
 vertex
...
factor of two from  the equivalent number for the LHC detectors. 
...
thermal management of the detector concept.  As a benchmark,  the total
...
placed inside the coil which is providing the central magnetic field,
...
much thinner silicon layers. ILD tries to optimise the particle-flow
...
This baseline design with two detectors and a push-pull arrangement
has distinct scientific advantages over a potential alternative of
only one detector. It is also much less expensive than the previously
considered alternative of having two separate interaction points with
dedicated detectors. The scientific advantages arise from the
...
detectors in one interaction region has needed
needs significant engineering work to demonstrate its
...
consumption.
The individual detector elements need to be designed for high
...
composing the experiment. This allowed us,  in particular, to bring
the PFA technique to maturity based on real experimental input.
...
For over a decade, the ILC community has developed and improved its
 software ecosystem, the reconstruction toolkit
  \emph{iLCSoft}~\cite{bib:ilcsoft}, which
...
campaigns. Based on these studies, we are
...
should continue to do so if the ILC is approved.  In the next stage,
we will put 
a strong focus on adapting the software tools for
...
Matter.   The ILC polarized beams offer additional precision tests of
...
become
 ...
 mysteries of the SM in a way that is orthogonal to direct new particles
 searches. We have discussed in Section~II that the ILC capabilities 
for precision tests
will be qualitatively superior  to those of the high-luminosity LHC. 
 This makes the ILC a compelling way forward, complementing  future LHC
 particle searches, to discover the new interactions that underlie the
 SM. 
 
The goal of a precise understanding of the Higgs boson is a compelling
...
with a reasonable cost estimate
...
polarization to achieve similar physics
...
We have emphasized in the previous few sections that the ILC proposal
...
of the ILC250 is shown in Appendix A. 
 This cost has  been scrutinized in a number of
studies, most recently by a working group of the Japanese science
agency MEXT, as described below.  Here too, we are ready to move forward.

A strong community of universities and laboratories world-wide is
eager to realise the ILC, to develop its detectors, and to exploit its
...
SCRF in Europe and the US has opened strong links between the ILC
community 
...
These industrial mini-workshops have been well attended
 with growing  interest and participation from individual companies and from the 
 industrial associations of several key countries.


On the political side, broad interest for the ILC in Japan has been
steadily growing over many year.  The plan for  hosting the ILC
in Japan  is being promoted by political entities, at
the Japanese Diet and at the provincial levels, by a large industrial 
consortium (AAA), and by representatives of the particles physics
community (JAHEP).  Since 2013, the ILC project has been 
examined extensively by the MEXT ministry within a
cautious official procedure, in which  minimising risks of any sort is of
...
leadership of  KEK.   Canada, China, India, Australia, and other
...
ILC and its detectors, and to pursue its unique 
physics program.  The machine technology is mature
and construction-ready. The recent construction of the European XFEL
...
countries are being approached by Japan, and others will follow. The
envisaged timeline of the project includes 4 years of preparation
phase and 9 years of construction. The ILC will deliver unique contributions in our
effort to probe beyond the Standard Model to an ultimate understanding
of the fundamental laws of nature. 
The scientific case for the ILC
...
\begin{figure*}[ht]
 %\epsfysize=9.0cm
 \begin{center}
 \includegraphics[width=19cm, height=10cm]{figures/Cost.png}
\caption{Cost of the ILC250 project as being re-evaluated by the Japanese MEXT report. Presented by Sh. Michizono during LCWS 2018. See link: https://agenda.linearcollider.org/event/7889/timetable/. \label{Cost}}
 \end{center}
 \end{figure*}
