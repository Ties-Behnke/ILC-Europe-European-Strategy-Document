...
In this section, we will discuss the prospects at the ILC for the
...
ILC---like LEP---will explore all corners of the parameter spaces of
...
However,
%the NLSP cannot be a coloured particle in R-parity conserving SUSY.
both theoretically, and given these limits,
it is quite unlikely that a coloured sparticle would be the NLSP.
%In R-parity conserving SUSY, the gluino cannot be the NLSP.
...
fully exploited.
\iffalse
{\color{red} Maybe rework the plot again to show the full HL=LHC projection, which
shows that basically nothing the GUT-uni allowed region will ever be discoverable
at LHC? Maybe as a subfig b ?}
\fi
\begin{figure*}[]
   \centering
...
\begin{figure*}[]
  \begin{center}
    ...
    \hspace{0.05\linewidth}
    \subfigure[]{\includegraphics [width=0.45\linewidth]{chapters/figures/fit_ilc2_EmL}}
%%% EdleeL.pdf}}
  \end{center}
...
%To aid the reader, we note that $m_{\tg}\sim 2.5 m_{1/2}$.}
\end{figure*}
...
\begin{figure*}[]
\setlength{\unitlength}{1.0cm}
\subfigure[]{\includegraphics[width=0.35\linewidth]{chapters/figures/po_muon_kcut_recoil_mass_summary1}}
\hspace{0.0\linewidth}
\subfigure[]{\includegraphics[width=0.3\linewidth]{chapters/figures/f_coupling_compare_LEP_and_PFO_final_cut_with_same_cut}}
\hspace{0.0\linewidth}
\subfigure[]{\includegraphics[width=0.3\linewidth]{chapters/figures/f_coupling_250_and_500}}
%f_coupling_compare_LEP_and_PFO_final_cut_with_same_cut}}
% \end{center}
