...
using detailed fast simulation SGV, see \ref{sec:sw_sgv}.
...
The models studied allows for \selr, \smur. and \stone~production also
at \Ecms = 250 GeV.
\begin{figure*}[]
  \begin{center}
...
simulation. (b) the neutral higgsino from the energy of its visible decay products in a scenario with a mass splitting of  $20$\,GeV~\cite{Baer:2016new}, using full detector simulation.}
\end{figure*}
