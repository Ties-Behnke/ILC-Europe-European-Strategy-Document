...
gradient of cavities produced for the European XFEL, separated by vendor \cite{Reschke:2017gjp}. 
...
transforming continuous low-current, low voltage electricity into short high-power pulses of the required high voltage of \siunit{120}{kV} at a current of \siunit{140}{A}.
...
{\it CONTINUE HERE WITH KLYSTRONS AND PDS}
...
These strings are supplied with liquid helium by several cryogenic plants~\cite[Sec. 3.5]{Adolphsen:2013kya} of a size similar to those in operation at CERN for the LHC, at Fermilab, and DESY. 
...
\paragraph{Polarisation upgrade}
...
Studies indicate that $60\,\%$ positron polarisation at the IP may be possible at \siunit{500}{GeV} centre--of--mass energy.
