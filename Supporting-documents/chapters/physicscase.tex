...
There are two problems with this method.  First, the method is not completely model-independent.  Modelling the effects of new physics as a general set of dimension-6 operators as in \leqn{geneffL}, we find two different Lorentz structures for the modifications of the $HZZ$ vertex,
\beq
