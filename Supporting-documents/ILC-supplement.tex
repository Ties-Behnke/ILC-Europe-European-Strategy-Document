...
\usepackage{latexsym, amsfonts, wasysym}
...
\affiliation{\vspace{.2 cm}$^1$DESY, $^2$U. Oregon, $^3$BNL, $^{4}$KEK, $^{5}$IFIC, U. Valencia-CSIC, $^6$SLAC, $^7$LAL-Orsay/CNRS, $^8$Max Planck, Munich, $^9$U. Tokyo,   $^{10}$U. Texas, Arlington, $^{11}$U. Kansas, $^{12}$U. Tohoku }
